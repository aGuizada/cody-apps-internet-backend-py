...
app.add_middleware(
    ...
    allow_origins=["http://localhost:4200", "http://localhost:8080", "https://cody-apps-internet-frontend-btj5k0d29-a-guizada.vercel.app","https://cody-apps-internet-frontend-ng-rho.vercel.app"],
